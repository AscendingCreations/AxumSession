...
[![https://crates.io/crates/axum_database_sessions](https://img.shields.io/badge/crates.io-v0.4.0-blue)](https://crates.io/crates/axum_database_sessions)
...
[dependencies]
# Postgres + rustls
axum_database_sessions = { version = "0.4", features = [ "postgres", "rustls"] }
```
