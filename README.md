...
[![https://crates.io/crates/axum_database_sessions](https://img.shields.io/badge/crates.io-v3.0.1-blue)](https://crates.io/crates/axum_database_sessions)
...
[dependencies]
# Postgres + rustls
axum_database_sessions = { version = "3.0.1", features = [ "postgres", "rustls"] }
```
