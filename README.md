...
[![https://crates.io/crates/axum_database_sessions](https://img.shields.io/badge/crates.io-v1.2.0-blue)](https://crates.io/crates/axum_database_sessions)
...
[dependencies]
# Postgres + rustls
axum_database_sessions = { version = "1.2", features = [ "postgres", "rustls"] }
```
