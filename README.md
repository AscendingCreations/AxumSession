...
[![https://crates.io/crates/axum_database_sessions](https://img.shields.io/badge/crates.io-v2.0.0-blue)](https://crates.io/crates/axum_database_sessions)
...
[dependencies]
# Postgres + rustls
axum_database_sessions = { version = "2.0", features = [ "postgres", "rustls"] }
```
