...
use crate::{AxumSessionData, AxumSessionID, AxumSessionStore, CookiesExt, databases::database::AxumDatabasePool};
...
#[derive(Debug, Clone)]
pub struct AxumSession<T>where T: AxumDatabasePool + Clone + fmt::Debug + std::marker::Sync + std::marker::Send + 'static   {
...
impl<S> AxumSession<S> where S: AxumDatabasePool + Clone + fmt::Debug + std::marker::Sync + std::marker::Send + 'static{
